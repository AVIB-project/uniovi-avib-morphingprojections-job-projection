...
Welcome to `uniovi-avib-morphingprojections-job-projection` contributor's guide.
...
If you experience bugs or general issues with `uniovi-avib-morphingprojections-job-projection`, please have a look
...
You can help improve `uniovi-avib-morphingprojections-job-projection` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`uniovi-avib-morphingprojections-job-projection` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `uniovi-avib-morphingprojections-job-projection`'s files. While this mechanism can
...
```
conda create -n uniovi-avib-morphingprojections-job-projection python=3 six virtualenv pytest pytest-cov
conda activate uniovi-avib-morphingprojections-job-projection
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/uniovi-avib-morphingprojections-job-projection.git
...
5. Install [pre-commit]:
   ...
   `uniovi-avib-morphingprojections-job-projection` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/uniovi-avib-morphingprojections-job-projection
[issue tracker]: https://github.com/<USERNAME>/uniovi-avib-morphingprojections-job-projection/issues
